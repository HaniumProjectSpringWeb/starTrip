...
(function(m,ma){
    ...
    function Yb(a,b,e){
        ...
        function ga(k){
            if(!b.lazyFetching||ya(n.visStart,n.visEnd))
            ra();
            else k&&da()
        }
        function ra(){
                        ...
                        if(sa=="title"){
                            ...
                            if(a[sa])
                                ...
                                Ja[sa])ha=function(){
                                    ...
                                    a.changeView(sa)};
                                    if(ha){
                                        ra=b.theme?jb(b.buttonIcons,sa):null;var da=jb(b.buttonText,sa),na=m("<span class='fc-button fc-button-"+sa+" "+q+"-state-default'><span class='fc-button-inner'><span class='fc-button-content'>"+(ra?"<span class='fc-icon-wrap'><span class='ui-icon ui-icon-"+ra+"'/></span>":da)+"</span><span class='fc-button-effect'><span></span></span></span></span>");
                                        ...
                                        if(na){
                                            ...
                                            function(){
                                                na.not("."+q+"-state-active").not("."+q+"-state-disabled").addClass(q+"-state-down")}).mouseup(
                                                    function(){
                                                        na.removeClass(q+"-state-down")
                                                    }).hover(
                                                    function(){
                                                        na.not("."+q+"-state-active").not("."+q+"-state-disabled").addClass(q+"-state-hover")},function(){
                                                            na.removeClass(q+"-state-hover").removeClass(q+"-state-down")}).appendTo(fa);
        ...
        function $b(a,b){
            ...
            function g(c,z){
                ...
                function y(c){
                    ...
                    for(z=0;z<H;z++){
                        ...
                        if(T._id==c._id&&T!=c){
                            ...
                            T.title=c.title;T.url=c.url;
                            T.allDay=c.allDay;T.className=c.className;
                ...
                function oa(c){
                    ...
                    c._id=c._id||(c.id===ma?"_fc"+bc++:c.id+"");if(c.date){if(!c.start)c.start=c.date;delete c.date}c._start=N(c.start=kb(c.start,H));c.end=kb(c.end,H);
            ...
            function hb(a,b,e){
                if(+a){
                    ...
                    d.setMonth(b);
                    a.setMonth(b);
                    for(e||Ka(a);a.getMonth()!=d.getMonth();)
                    ...
                    var e=new Date(a[1],0,1);
                        if(b||!a[13]){
                            b=new Date(a[1],0,1,9,0);
                                if(a[3]){
                                    e.setMonth(a[3]-1);b.setMonth(a[3]-1)
                                }
                                if(a[5]){
                                    e.setDate(a[5]);
                                    b.setDate(a[5])
                            ...
                            e.setUTCHours(a[7]||0,a[8]||0,a[10]||0,a[12]?Number("0."+a[12])*1E3:0);
                                if(a[14]){
                                    ...
                                    b*=a[15]=="-"?1:-1;e=new Date(+e+b*60*1E3)
                                }
                        }
                        return e
            }
                ...
                if(typeof a=="number")
                    ...
                    if(typeof a=="object")
                        ...
                        if(a=a.match(/(\d+)(?::(\d+))?\s*(\w+)?/)){
                            ...
                            if(a[3]){
                                b%=12;if(a[3].toLowerCase().charAt(0)=="p")b+=12
                            }
            ...
            function Db(a,b,e){
                a.unbind("mouseover").mouseover(function(d){
                    ...
                    if((f=g._fci)!==ma){g._fci=ma;g=b[f];e(g.event,g.element,g);m(d.target).trigger(d)}d.stopPropagation()})}function Va(a,b,e){for(var d=0,f;d<a.length;d++){f=m(a[d]);f.width(Math.max(0,b-pb(f,e)))}}function Eb(a,b,e){for(var d=0,f;d<a.length;d++){f=m(a[d]);f.height(Math.max(0,b-Sa(f,e)))}}function pb(a,b){return gc(a)+hc(a)+(b?ic(a):0)}function gc(a){return(parseFloat(m.css(a[0],"paddingLeft",true))||0)+(parseFloat(m.css(a[0],"paddingRight",true))||0)}function ic(a){return(parseFloat(m.css(a[0],"marginLeft",
